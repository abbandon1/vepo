...
public class HotelStay extends by.psu.first.TourService {

    private int stars;
    private int nights;
    private by.psu.first.RoomType roomType;

    public HotelStay() {
    }

    public HotelStay(Integer id, String name, BigDecimal price, LocalDate from, LocalDate to,
                     int stars, int nights, by.psu.first.RoomType roomType) {
    ...
    public by.psu.first.RoomType getRoomType() {
        return roomType;
    }

    public void setRoomType(by.psu.first.RoomType roomType) {
        this.roomType = roomType;
    }
